...
__kernel void cache(__global float* A, int row, int col, __local float* lA)
{
...
__kernel void mul(__local float* A, __local float* B, __local float* C)
{
